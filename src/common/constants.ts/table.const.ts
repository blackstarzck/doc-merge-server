export const TABLE_COLUMNS = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: '발주일', key: 'order_date' },
      { name: '작성자', key: 'author' },
      { name: '진행업체', key: 'parent_company' },
      { name: '발주건', key: 'order_item' },
      { name: '기초금액', key: 'base_price' },
      { name: '낙찰가(공급가)', key: 'bid_price' },
      { name: '매입가', key: 'purchase_price' },
      { name: '매입률(%)', key: 'purchase_rate' },
      { name: '이익금', key: 'profit' },
      { name: '이익률(%)', key: 'profit_rate' },
      { name: '현황', key: 'status' },
      { name: '수금일', key: 'collection_date' },
      { name: '송금일', key: 'remittance_date' },
      { name: '계산서', key: 'invoice_received_date' },
      { name: '계산서수신사업자', key: 'invoice_recipient' },
      { name: '계좌정보', key: 'account_info' },
      { name: '담당자', key: 'manager' },
      { name: '담당자전화번호', key: 'manager_phone' }
    ]
  },
  {
    label: '매출처 원장',
    ...
    columns: [
      ...
      { name: '도서정가', key: 'bk_price' },
      { name: '도서공급율', key: 'bk_supply_rate' },
      { name: '공급가', key: 'bk_supply_price' },
      { name: '입금액', key: 'total_payment' },
      { name: '매입율', key: 'purchase_rate' },
      { name: '매입액', key: 'purchase_amount' },
      { name: '이익율', key: 'profit_rate' },
      { name: '이익금', key: 'profit' },
      { name: '잔액', key: 'balance' },
      { name: '계산서발행일', key: 'invoice_date' },
      { name: '비고', key: 'remarks' }
    ]
  },
  {
    ...
    columns: [
      ...
      { name: '(마크장비)장비 시작', key: 'equipment_start' },
      { name: '(마크장비)투입인원수', key: 'personnel_count' },
      { name: '(마크장비)장비 완료', key: 'completion' },
